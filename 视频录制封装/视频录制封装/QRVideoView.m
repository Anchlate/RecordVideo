...
- (NSString *)getVideoMergeFilePathString
{
    ...
    NSString *fileName = [[self.videoDirectoryPath stringByAppendingPathComponent:nowTimeStr] stringByAppendingString:@"merge.mp4"];
...
- (NSString *)getVideoSaveFilePathString
{
    ...
    NSString *fileName = [[self.videoDirectoryPath stringByAppendingPathComponent:nowTimeStr] stringByAppendingString:@".mov"];
