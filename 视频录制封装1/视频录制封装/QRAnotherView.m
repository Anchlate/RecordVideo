...
@interface QRAnotherView ()<AVCaptureFileOutputRecordingDelegate>
...
-(void)initCapture{
    ...
    //    shootBt.backgroundColor = [UIColor blueColor];
...
- (void)mergeAndExportVideosAtFileURLs:(NSMutableArray *)fileURLArray outputFileURL:(NSURL *)outputFileURL
{
    ...
    [exporter exportAsynchronouslyWithCompletionHandler:^{
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            float size = [BPClearCach cachSizeAtPath:[mergeFileURL path]];
